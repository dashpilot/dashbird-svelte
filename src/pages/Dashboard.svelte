<script>
    ...
    let totalPosts = $derived(data.posts.length);
            ...
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        ...
                        <dd class="text-lg font-semibold text-gray-900">{totalPosts}</dd>
                    </dl>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white overflow-hidden shadow rounded-lg">
        <div class="p-5">
            <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                    <dl>
                        <dt class="text-sm font-medium text-gray-500 truncate">Total Drafts</dt>
                        <dd class="text-lg font-semibold text-gray-900">1</dd>
                    </dl>
                </div>
            </div>
        </div>
